...
import { PlantGrowthLogType, Prisma } from "prisma/generated/client";

export class MeasurementGrowthLogDTO extends PlantGrowthLogBaseDTO implements IPlantGrowthLogDTO {
  measurement!: {
    height?: number;
    temperature?: string;
    humidity?: string;
